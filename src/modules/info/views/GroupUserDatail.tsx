...
interface GroupUserDetailPopProps {
    srcUserId : string;
    CreateUser : boolean;
    groupUserDetailPopOpen: boolean;
    setGroupUserDetailPopOpen: (open: boolean) => void;
    onSearch: () => void;
}

const GroupUserDetailPop : React.FC<GroupUserDetailPopProps> = ({srcUserId, CreateUser, groupUserDetailPopOpen, setGroupUserDetailPopOpen, onSearch}) => {
    ...
    // 값 세팅
    const onSetGroupUserData = (e : React.ChangeEvent<HTMLInputElement>) => {
    ...
    const onSetGroupUserDataSelect  = (e : React.ChangeEvent<HTMLSelectElement>) => {
    ...
    }, [setGroupUserDetailData, setGroupUserDetailPopOpen]);
            ...
            <Modal.Body>
                ...
                <div className="flex align-items-center mt10" style={{height : '50px'}}>
                    <div className="formTi7t flex-shrink0 width120px">소속 계열사 <span className="star">*</span></div>
                    {
                        ...
                        <div className="width100"  >
                            {
                                InterrelatedCustCodeList.length > 0 && (
                                    <select name="interrelatedCustCode" className="selectStyle" onChange={onSetGroupUserDataSelect}>
                                        <option value="">선택</option>
                                        {InterrelatedCustCodeList.map((option, index) => (
                                            <option key={index} value={option.interrelatedCustCode as string}>
                                                {option.interrelatedNm as string}
                                            </option>
                                        ))}
                                    </select>
                                    )
                        ...
                        :
                        <div className="width100">
                            { GroupUserDetailData.interrelatedNm as string}
                        </div>
                    }
                </div>
                <div className="flex align-items-center mt10">
                    ...
                    <div className="width100">
                        <select name="userAuth" className="selectStyle" value={GroupUserDetailData.userAuth} onChange={onSetGroupUserDataSelect}>
                            <option value="">선택</option>
                ...
                <div className="flex align-items-center mt20">
                    ...
                    <div className="width100">
                        <select name="openauth" className="selectStyle" onChange={onSetGroupUserDataSelect}>
                ...
                <div className="flex align-items-center mt20">
                    ...
                    <div className="width100">
                        <select name="bidauth" className="selectStyle" onChange={onSetGroupUserDataSelect}>
                            <option value="">아니오</option>
                ...
                </div>
                {
                    ...
                    <div className="flex align-items-center mt10" v-if="!this.CreateUser">
                        ...
                        <div className="width100">
                            최종변경일 : { GroupUserDetailData.pwdEditDateStr as string }
                        </div>
                ...
                <div className="flex align-items-center mt10">
                    ...
                    <div className="width100"><input type="text" name="userEmail" className="inputStyle" value={GroupUserDetailData.userEmail} placeholder="test@bitcube.co.kr" onChange={onSetGroupUserData}/></div>
                </div>
                <div className="flex align-items-center mt10">
                ...
                <div className="flex align-items-center mt10">
                    ...
                    <div className="width100">
                        <select name="useYn" className="selectStyle" onChange={onSetGroupUserDataSelect}>
