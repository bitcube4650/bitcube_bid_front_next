...
const SrcSelectBox = (props: SrcSelectBoxProps) => {
    ...
    // <SrcSelectBox   name={"useYn"} optionList={useYnOptionList} valueKey="value" nameKey="name" totalText="전체" .... />
    // <SrcSelectBox   name={"interrelatedCustCode"} optionList={InterrelatedCustCodeList} valueKey="interrelatedCustCode" nameKey="interrelatedNm" totalText="전체" .... />
