                    ...
                    <div class="mcl_left mainConBox" style={{height: '700px'}}>
                        ...
                        <div class="biddingList">
                            <a click="moveBiddingPage('planning')" class="biddingStep1">
                                ...
                                <div class="biddingListRight"><span>{ bidInfo.planning }0</span>건<i class="fa-light fa-angle-right"></i></div>
                            </a>
                            <a  click="moveBiddingPage('noticing')" class="biddingStep2">
                                ...
                                <div class="biddingListRight"><span>{ bidInfo.noticing }0</span>건<i class="fa-light fa-angle-right"></i></div>
                            </a>
                            <a  click="moveBiddingPage('beforeOpening')" class="biddingStep3">
                                ...
                                <div class="biddingListRight"><span>{ bidInfo.beforeOpening }0</span>건<i class="fa-light fa-angle-right"></i></div>
                            </a>
                            <a  click="moveBiddingPage('opening')" class="biddingStep4">
                                ...
                                <div class="biddingListRight"><span>{ bidInfo.opening }0</span>건<i class="fa-light fa-angle-right"></i></div>
                            </a>
                            <a  click="moveBiddingPage('completed')" class="biddingStep5">
                                ...
                                <div class="biddingListRight"><span>{ bidInfo.completed }0</span>건<i class="fa-light fa-angle-right"></i></div>
                            </a>
                            <a  click="moveBiddingPage('unsuccessful')" class="biddingStep5">
                                ...
                                <div class="biddingListRight"><span>{ bidInfo.unsuccessful }0</span>건<i class="fa-light fa-angle-right"></i></div>
                            </a>
                        </div>
                    </div>
                    <div class="mcl_right">
